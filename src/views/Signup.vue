                ...
                <v-card class="elevation-12">
                    ...
                    <v-card-text>
                        ...
                        <v-form v-model="valid">
                            <v-text-field prepend-icon="person" name="login" label="Е-мейл" type="email"
                                          required v-model="email" :rules="emailRules"></v-text-field>
                            <v-text-field id="password" prepend-icon="lock" name="password" label="Пароль"
                                          type="password" required v-model="password" :rules="passwordRules"></v-text-field>
                        </v-form>
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
